...
<section class="menu">
    ...
    <article>
            <!-- Text área -->
        <label for="nombre"> Ejemplo de un textarea </label>
        <textarea id="TextArea1" placeholder="Escribe algo aquí: "></textarea>

    <form onsubmit="return validarFecha()" onsubmit="validarGenero()" >

    <!-- Input normal -->
    <label for="nombre">Nombre:</label> 
    <input type="text" id="nombre" name="nombre" required pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s'-]+" oninput="validarNombre()" placeholder="Introduce tu nombre"> 
    ...
    <!-- select -->
    <label for="campo-eleccion">Elige una opción:</label>
    <select id="campo-eleccion" name="campo-eleccion" required>
    ...
    <input type="date" id="fechacom"required>
